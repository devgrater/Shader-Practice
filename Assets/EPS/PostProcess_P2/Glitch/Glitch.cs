...
[System.Serializable]
[PostProcess(typeof(GlitchRenderer), PostProcessEvent.AfterStack, "Custom/Screen Glitch")]
...
public sealed class GlitchRenderer : PostProcessEffectRenderer<Glitch>
{
    ...
    {   
        ...
        var sheet = context.propertySheets.Get(Shader.Find("Hidden/Custom/Glitch Effect"));
