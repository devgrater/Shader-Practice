...
//a very customized version of autolight
#ifndef GRATERVLIGHT_INCLUDED
#define GRATERVLIGHT_INCLUDED
...
// ------------ Shadow helpers --------
	...
	// ---- Screen space shadows
        ...
        #define CAM_COORDS(idx1, idx2) float4 _ShadowCoord : TEXCOORD##idx1; float4 _CameraDir : TEXCOORD##idx2;

		#if defined(UNITY_NO_SCREENSPACE_SHADOWS)
			#define TRANSFER_SHADOW(a) a._ShadowCoord = mul( unity_WorldToShadow[0], mul( unity_ObjectToWorld, v.vertex ) );
            #define TRANSFER_SHADOW_VECTOR(a) a._ShadowCoord = mul(unity_WorldToShadow[0], _WorldSpaceCameraPos); 
                \ a._CameraDir = mul(unity_WorldToShadow[0], mul(unity_ObjectToWorld, float4(o.osViewDir));
            ...
            /*
            #define TRANSFER_SHADOW_VECTOR(a) a._ShadowCoord = mul(unity_WorldToShadow[0], mul(unity_ObjectToWorld, v.vertex)); 
                \ a._CameraDir = mul(unity_WorldToShadow[0], mul(unity_ObjectToWorld, float4(o.osViewDir));*/
